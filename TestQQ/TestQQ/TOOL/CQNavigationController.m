...
@interface CQNavigationController ()<UIGestureRecognizerDelegate>
...
{
    [self.navigationBar setBackgroundImage:[UIImage skinImageWithName:@"header_bg_ios7.png"] forBarMetrics:UIBarMetricsDefault];
}
